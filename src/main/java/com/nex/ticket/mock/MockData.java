...
public class MockData {
    ...
    public static final List<Province> PROVINCES = Arrays.asList(
        new Province("bkk", "กรุงเทพฯ",       "Bangkok",            Arrays.asList("southern", "northern", "northeast", "eastern")),
    ...
    public static final List<Trip> TRIPS = Arrays.asList(
        new Trip("t1", "northern",  "bkk", "cnx", "08:00", "18:00",  550, 24, 40, "ด่วนพิเศษ", "VIP 24 ที่นั่ง",    "2026-03-05"),
        new Trip("t2", "northern",  "bkk", "cnx", "20:00", "06:00",  650, 12, 32, "ด่วนพิเศษ", "VIP 32 ที่นั่ง",    "2026-03-05"),
        new Trip("t3", "northern",  "bkk", "cnx", "21:30", "07:30",  750,  6, 24, "ด่วนพิเศษ", "VIP First Class",   "2026-03-05"),
        new Trip("t4", "southern",  "bkk", "hdy", "18:00", "07:00",  850, 18, 40, "ด่วนพิเศษ", "VIP 24 ที่นั่ง",    "2026-03-05"),
        new Trip("t5", "northeast", "bkk", "udn", "19:00", "05:00",  480, 30, 40, "ปรับอากาศ", "ป.1 (ป.อ.)",        "2026-03-05"),
        new Trip("t6", "southern",  "bkk", "skn", "19:00", "05:30",  600, 20, 40, "ด่วนพิเศษ", "VIP 24 ที่นั่ง",    "2026-03-05"),
        new Trip("t7", "southern",  "bkk", "skn", "21:00", "07:00",  700, 14, 32, "ด่วนพิเศษ", "VIP 32 ที่นั่ง",    "2026-03-05"),
        new Trip("t8", "eastern",   "bkk", "pty", "09:00", "12:00",  200, 35, 40, "ปรับอากาศ", "ป.1 (ป.อ.)",        "2026-03-05")
    );
    ...
    public static Promotion findPromotionByCode(String promoCode) {
        return PROMOTIONS.stream().filter(p -> p.getPromoCode().equalsIgnoreCase(promoCode)).findFirst().orElse(null);
    }
}
